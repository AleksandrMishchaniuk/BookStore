module OrderStrategy
  # :nodoc:
  class PersistByStorage < PersistBase
    def initialize(coupon_storage, coupon_key, order_storage, order_key)
      super(coupon_storage, coupon_key)
      raise 'argument #3 sould be instance of Storage' unless order_storage.is_a? Storage
      raise 'argument #4 sould be instance of Symbol' unless order_key.is_a? Symbol
