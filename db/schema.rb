...
ActiveRecord::Schema.define(version: 20160912124237) do
  ...
  create_table "soc_auths", force: :cascade do |t|
  ...
  add_index "soc_auths", ["provider"], name: "index_soc_auths_on_provider", using: :btree
  add_index "soc_auths", ["uid"], name: "index_soc_auths_on_uid", using: :btree
  add_index "soc_auths", ["user_id"], name: "index_soc_auths_on_user_id", using: :btree
